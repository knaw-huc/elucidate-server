...
public interface AnnotationPageSearchService<A extends AbstractAnnotation, P extends AbstractAnnotationPage> {
    ...
    ServiceResponse<P> buildAnnotationPageByRange(List<A> annotations, String targetId, float rangeStart, float rangeEnd, int page, boolean embeddedDescriptions);

    ServiceResponse<P> buildAnnotationPageByOverlap(List<A> annotations, String targetId, float rangeStart, float rangeEnd, int page, boolean embeddedDescriptions);
}
