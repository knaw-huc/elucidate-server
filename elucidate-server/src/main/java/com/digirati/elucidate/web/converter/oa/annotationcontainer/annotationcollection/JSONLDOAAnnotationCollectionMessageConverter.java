...
public class JSONLDOAAnnotationCollectionMessageConverter extends AbstractOAAnnotationCollectionMessageConverter {
    ...
    @Autowired
    public JSONLDOAAnnotationCollectionMessageConverter(@NotNull @Value("${annotation.collection.oa.contexts}") String[] defaultContexts) {
    ...
    protected String getStringRepresentation(@NotNull OAAnnotationCollection oaAnnotationCollection, @NotNull MediaType contentType) throws Exception {
    ...
    @Override
    @SuppressWarnings("unchecked")
    protected OAAnnotationCollection getObjectRepresentation(@NotNull String jsonStr, MediaType contentType) throws Exception {
