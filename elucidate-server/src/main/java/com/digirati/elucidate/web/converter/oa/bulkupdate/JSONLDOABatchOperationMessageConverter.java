...
public class JSONLDOABatchOperationMessageConverter extends AbstractOABatchOperationMessageConverter {
    ...
    @Autowired
    public JSONLDOABatchOperationMessageConverter(@NotNull @Value("${batch.operation.oa.contexts}") String[] defaultContexts) {
    ...
    protected String getStringRepresentation(@NotNull OABatchOperation oaBatchOperation, @NotNull MediaType contentType) throws Exception {
    ...
    @Override
    @SuppressWarnings("unchecked")
    protected OABatchOperation getObjectRepresentation(@NotNull String jsonStr, MediaType contentType) throws Exception {
