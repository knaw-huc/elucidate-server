...
public class JSONLDW3CAnnotationCollectionMessageConverter extends AbstractW3CAnnotationCollectionMessageConverter {
    ...
    @Autowired
    public JSONLDW3CAnnotationCollectionMessageConverter(@NotNull @Value("${annotation.collection.w3c.contexts}") String[] defaultContexts) {
    ...
    protected String getStringRepresentation(@NotNull W3CAnnotationCollection w3cAnnotationCollection, @NotNull MediaType contentType) throws Exception {
    ...
    @Override
    @SuppressWarnings("unchecked")
    protected W3CAnnotationCollection getObjectRepresentation(@NotNull String jsonStr, MediaType contentType) throws Exception {
