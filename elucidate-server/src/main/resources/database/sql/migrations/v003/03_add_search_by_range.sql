...
ALTER            FUNCTION public.annotation_search_by_range(character varying, character varying, integer, integer) OWNER TO postgres;
GRANT EXECUTE ON FUNCTION public.annotation_search_by_range(character varying, character varying, integer, integer) TO postgres;
GRANT EXECUTE ON FUNCTION public.annotation_search_by_range(character varying, character varying, integer, integer) TO annotations_role;
REVOKE ALL    ON FUNCTION public.annotation_search_by_range(character varying, character varying, integer, integer) FROM public;

-- usage example:
-- select * from public.annotation_search_by_range('https://demorepo.tt.di.huc.knaw.nl/task/find/volume-1728/contents', 'urn:example:republic:TextAnchorSelector', 55900, 55990);
--